...
def build_create_request(
    **kwargs  # type: Any
    ...
    directory_properties = kwargs.pop('directory_properties', None)  # type: Optional[str]
    posix_permissions = kwargs.pop('posix_permissions', None)  # type: Optional[str]
    posix_umask = kwargs.pop('posix_umask', None)  # type: Optional[str]
...
def build_rename_request(
    **kwargs  # type: Any
    ...
    path_rename_mode = kwargs.pop('path_rename_mode', None)  # type: Optional[Union[str, "_models.PathRenameMode"]]
    directory_properties = kwargs.pop('directory_properties', None)  # type: Optional[str]
    posix_permissions = kwargs.pop('posix_permissions', None)  # type: Optional[str]
    posix_umask = kwargs.pop('posix_umask', None)  # type: Optional[str]
    cache_control = kwargs.pop('cache_control', None)  # type: Optional[str]
...
def build_delete_request(
    **kwargs  # type: Any
    ...
    :rtype: ~azure.storage.blob.core.rest.HttpRequest
    """
    recursive_directory_delete = kwargs.pop('recursive_directory_delete')  # type: bool
    timeout = kwargs.pop('timeout', None)  # type: Optional[int]
    marker = kwargs.pop('marker', None)  # type: Optional[str]
    lease_id = kwargs.pop('lease_id', None)  # type: Optional[str]
    if_modified_since = kwargs.pop('if_modified_since', None)  # type: Optional[datetime.datetime]
...
def build_set_access_control_request(
    **kwargs  # type: Any
    ...
    posix_permissions = kwargs.pop('posix_permissions', None)  # type: Optional[str]
    posix_acl = kwargs.pop('posix_acl', None)  # type: Optional[str]
    if_match = kwargs.pop('if_match', None)  # type: Optional[str]
    if_none_match = kwargs.pop('if_none_match', None)  # type: Optional[str]
    if_modified_since = kwargs.pop('if_modified_since', None)  # type: Optional[datetime.datetime]
    if_unmodified_since = kwargs.pop('if_unmodified_since', None)  # type: Optional[datetime.datetime]
